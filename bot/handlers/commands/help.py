...
P. S. Если не работает какая то из команда, это означает, что вы сейчас используете другую команду
В таком случае, чтобы начать работу с другой командой, либо закройте диалоговое окно прошлой команды,
