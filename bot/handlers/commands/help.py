...
Для /add_hw можно использовать аргументы для создания домашнего задания без дополнительных диалогов:
<i>/add_hw &ltпредмет, название, подгруппа, срок сдачи, *описание, *важность&gt</i> 
* - необязательные параметры
<b>Порядок аргументов важен</b>

Так же можно использовать аргументы для быстрого поиска, удаления и изменения домашнего задания:
<i>/show_hws &ltпредмет&gt &ltподгруппа&gt &ltназвание&gt &ltсрок сдачи&gt &ltописание&gt</i>
...
- <i>!у иностранные языки тест 02.02.2021 подготовиться к тесту по пятой теме</i>

<b>inline-команды:</b>
Для ввода inline-команд перед командой надо поставить тег бота @itai_hw_bot
-<i>show_hw &ltключевые слова&gt</i> - поиск домашних заданий по ключевым словам
-<i>add_hw &ltпредмет, название, подгруппа, срок сдачи, *описание, *важность&gt</i> -
быстрое добавление домашнего задания
