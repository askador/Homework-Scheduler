...
import bot.tests.tests_bot.show_hw.pyppeteer.pyppeteer
from bot.tests.tests_bot.show_hw.pyppeteer.pyppeteer.connection import CDPSession
from bot.tests.tests_bot.show_hw.pyppeteer.pyppeteer.errors import ElementHandleError, TimeoutError
